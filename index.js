...
// Anticrash: evita que o bot desligue por erros não tratados
...
client.setMaxListeners(25); // Aumenta o limite para 30, ajustável conforme necessário
...
const webhookUrl = "https://discord.com/api/webhooks/1437809443629694980/8lmk-kGvhOPIyrnfjT1cGljB8upxCDn6jtsiha2VBGrccZJIBDapqHpVSL9o3l-Qxt1X"; // URL corrigida
...
client.on("ready", async () => {
    const activities = [
        { name: ` Os mais picas`, type: 1, url: 'https://www.twitch.tv/discord' },
    ];
